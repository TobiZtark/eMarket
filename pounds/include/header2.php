...
<head>
	...
	<body>
		...
		<header id="header" style="">
			<div class="container">
				<div class="span12">
					<div class="logo span11"><a href="index.php" style="margin-left:-8%;"><img src="images/logo.png" alt="logo"><h1 style="margin-top:; color:#000"></h1></a></div>
		...
		<div class="menu-lightbox">
			...
			<div class="dtable">
				...
				<div class="span4">
					...
					<button class="button spec-hover" name="login" value="submit" style="margin-bottom: 10%;"><span>Log In</span></button>
					<button type="button" class="button spec-hover" data-toggle="modal" data-target="#myModal" style="margin-bottom: 10%;"><span>Sign Up</button></span> <br>
