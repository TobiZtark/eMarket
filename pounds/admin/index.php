...
$res = $auth_user->doLogin($email, $email, $pass);
...
<script>
  ...
  ?>
<script>
  alert("No Love on these Streets!");
</script>
...
<head>
  ...
  <title>Pounds Apparel Admin - Login</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"> Pounds Apparel Administrator</h1>
                  </div>
